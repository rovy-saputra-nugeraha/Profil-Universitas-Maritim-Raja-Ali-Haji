<?php 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="number" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan NIP" required>
    </div>
  </div>
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <button type="button" onclick="hapusSiswa(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus Pegawai</button>
    </div>
  </div>
</form>
<?php
